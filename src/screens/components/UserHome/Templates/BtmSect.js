...
import bankAc from '../../../../assets/Images/bank-account.png'
    ...
    return (
        <View style={styles.ctrStyles.sectContainer}>
            ...
            <View style={styles.topsStyles.scanContainer}>
                <UserFtrLg img={bankAc} option="Create Account" onPress={onPress} />
            </View>
            <HPFtrs img={bg1} txt="Make payments easily & fastly and use your precious time" />
            <HPFtrs img={bg2} txt="Make payments using UPI from your mobile at one go" />
