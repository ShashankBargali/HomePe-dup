...
import pay from '../../../../assets/Images/sendMoney.png'
import passbook from '../../../../assets/Images/passbook.png'
import money from '../../../../assets/Images/wallet.png'
...
const TopSect = () => {
  ...
  return (
    <View style={styles.ctrStyles.sectContainer}>
      <Text style={[styles.txtStyles.mainHead,styles.txtStyles.txtCenter, styles.txtStyles.fontSigmar]}>UPI & Payments</Text>
